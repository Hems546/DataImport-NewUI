export const apiCall = async (
  ...
  dynamicBaseURL?: string
    ...
    if (import.meta.env.MODE === "development") {
        ...
        token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..f5hXlfJiHe2KbS7xmmbSTpGdYNmB2WWAjk0qhN8GlHw";
